...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        crw.getListaRecursos().add("file:///D:/downloads/BuscaPadraoWeb%20(1)/BuscaPadraoWeb/src/buscapadraoweb/teste.html");
        ...
        //transições de q1
        matriz[get_string_ref(estados, "q1")][get_char_ref(alfabeto, '.')] = get_string_ref(estados, "q2");
        //transições de q2
